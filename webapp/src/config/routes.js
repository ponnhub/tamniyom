...
const ImageMap = lazy(()=> import('pages/ImageMap/ImageMap'))

const Product = lazy(() => import('pages/Product/Product'))
const Cart = lazy(() => import('pages/Cart/Cart'))
const ImageViewer = lazy(() => import('pages/ImageViewer/ImageViewer'))
...
const routes = [
  ...
  },
  {
    ...
    element: (
      <UnauthorizedRoute>
        <PhoneSignUp redirectTo="/product" />
      </UnauthorizedRoute>
    ),
  },
  {
  ...
  {
    path: '/imageviewer/:catid/:productid/:desc',
    exact: true,
    element: <ImageViewer />,
  },
  {
